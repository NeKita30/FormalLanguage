...
def test_alphabet_good():
    ...
    m3 = NFA.NFA(alphabet="abcd", doa_file="testing_by_pytest/doa_texts/doa_1.doa")

    m4 = NFA.NFA(doa_file="testing_by_pytest/doa_texts/doa_1.doa")
...
def test_alphabet_error():
    ...
    with pytest.raises(Exception):
        m2 = NFA.NFA(alphabet="bcd", doa_file="testing_by_pytest/doa_texts/doa_1.doa")