...
def test_dfa_determ_one(mocker):
    ...
    dfa = DFA.DFA(alphabet='ab', doa_file="test_dfa_by_pytest/doa_texts/dfa_test_determ.doa")
...
def test_dfa_completes():
    ...
    dfa = DFA.DFA(alphabet="ab", doa_file="test_dfa_by_pytest/doa_texts/dfa_test_unusual.doa", to_dfa=False)
    dfa.make_complete_dfa()
...
def test_dfa_determ_two(mocker):
    dfa = DFA.DFA(alphabet='ab', doa_file="test_dfa_by_pytest/doa_texts/dfa_test_determ_unchanged.doa")
    dfa.make_complete_dfa()
